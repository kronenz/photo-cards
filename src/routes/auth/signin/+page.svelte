<script lang="ts">
	...
	import { scrollFadeUp, scrollScale } from '$lib/transitions/scroll-animations';
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
	...
	<div class="container mx-auto px-4 py-16">
		<div class="text-center mb-12" use:scrollFadeUp={{ duration: 700 }}>
		...
		<div class="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-16">
			<div class="text-center p-6 bg-white/50 dark:bg-gray-800/50 rounded-2xl backdrop-blur-sm" use:scrollScale={{ duration: 600, delay: 100 }}>
			...
			<div class="text-center p-6 bg-white/50 dark:bg-gray-800/50 rounded-2xl backdrop-blur-sm" use:scrollScale={{ duration: 600, delay: 200 }}>
			...
			<div class="text-center p-6 bg-white/50 dark:bg-gray-800/50 rounded-2xl backdrop-blur-sm" use:scrollScale={{ duration: 600, delay: 300 }}>
		...
		<!-- Call to Action -->
		<div class="text-center" use:scrollFadeUp={{ duration: 600, delay: 400 }}>
